						...
						<table class="table table-bordered table-striped mb-none" id="example">
							...
							<tbody>
								...
								?>
									<tr>
										...
										$resultsus = $db_li->query($querysus);
										while ($rowsus = $resultsus->fetch_assoc()) {
											$PEGAWAI = getnilaikaryawan($id, $id_pegawai, $rowsus['id_user']);
											echo '<th class="center">' . $PEGAWAI . '</th>';
							...
							<tr>
								<td colspan="2" height="30">
									<h5><b>Pegawai Terbaik :</b></h5>
								</td>
								<td colspan="10" height="30">
									<h5><b><?php echo $nama_pegawai[$rowj['id_pegawai']] . ' - SKOR NILAI : ' . $nilai[$rowj['id_pegawai']]; ?></b></h5>
								</td>
							</tr>
